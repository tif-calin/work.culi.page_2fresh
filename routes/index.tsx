...
const blockSectionClass = " min-h-[calc(100vh-6rem)] text-2xl p-12";
...
export default function Home() {
  return (
    <>
      ...
      <footer>
        <div
          class={`${sectionContentClass} flex flex-row flex-shrink flex-wrap gap-1 items-center justify-between`}
        >
